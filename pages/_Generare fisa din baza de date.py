    ...
    if st.session_state['file']!=None or st.session_state['ut']:
        ...
        if st.session_state['cap3']!=None:
            ...
            if "s37a" not in st.session_state:
             st.session_state["s37a"] = int(data_fis.get("M_3_7_a", 0))
            if "s37b" not in st.session_state:
             st.session_state["s37b"] = int(data_fis.get("M_3_7_b", 0))
            if "s37c" not in st.session_state:
             st.session_state["s37c"] = int(data_fis.get("M_3_7_c", 0))
            if "s37d" not in st.session_state:
             st.session_state["s37d"] = int(data_fis.get("M_3_7_d", 0))
            if "s37e" not in st.session_state:
             st.session_state["s37e"] = int(data_fis.get("M_3_7_e", 0))
